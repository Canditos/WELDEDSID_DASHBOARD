...
document.getElementById("reset-group-2-btn").addEventListener("click", () => resetRelayGroup([4, 5, 6, 7]));
document.getElementById("reset-group-3-btn").addEventListener("click", () => resetRelayGroup([8, 9, 10, 11]));
